			...
			<div class="step step1">
				...
				<table>
					...
					<tr>
						...
						<tr>
							<td width="60">
								<img src="${pageContext.request.contextPath}/<s:property value="#cartItem.product.pic"/>">
							</td>
							<td>
								<a target="_blank"><s:property value="#cartItem.product.name"/></a>
							</td>
							<td>
				...
				<div class="bottom">
				<span style="float:left;color:red;margin-left:45%"><s:actionmessage/></span>
					<a href="${pageContext.request.contextPath }/cart_clearCart.action" id="clear" class="clear">清空购物车</a>
					<a href="${pageContext.request.contextPath}/dindan_saveOrder.action" id="submit" class="submit">提交订单</a>
